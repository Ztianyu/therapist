...
public class AdministratorGroupFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
    ...
    public void initData() {
        radioButtonMember1.setText(ResourceUtil.resToStr(context, R.string.administratorTip1));
        radioButtonMember2.setText(ResourceUtil.resToStr(context, R.string.administratorTip2));
        radioButtonMember3.setText(ResourceUtil.resToStr(context, R.string.administratorTip3));
        radioButtonMember4.setText(ResourceUtil.resToStr(context, R.string.administratorTip4));
        ...
        Drawable drawable3 = ResourceUtil.resToDrawable(context, R.drawable.tab_sub_selector);
        drawable3.setBounds(0, 0, drawable3.getMinimumWidth(), drawable3.getMinimumHeight());
        Drawable drawable4 = ResourceUtil.resToDrawable(context, R.drawable.tab_notices_selector);
