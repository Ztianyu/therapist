...
import com.zty.therapist.ui.fragment.home.ClassRoomFragment;
...
public class ClassRoomActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        fragments.add(ClassRoomFragment.newInstance(0));
        fragments.add(ClassRoomFragment.newInstance(1));
        fragments.add(ClassRoomFragment.newInstance(2));
