package com.zty.therapist.imlib.chat.ui.fragment;
...
import  com.zty.therapist.imlib.chat.adapter.EmotionGridViewAdapter;
import  com.zty.therapist.imlib.chat.adapter.EmotionPagerAdapter;
import  com.zty.therapist.imlib.chat.ChatBaseFragment;
import  com.zty.therapist.imlib.chat.util.EmotionUtils;
import com.zty.therapist.imlib.chat.util.GlobalOnItemClickManagerUtils;
import  com.zty.therapist.imlib.chat.util.Utils;
import  com.zty.therapist.imlib.chat.widget.IndicatorView;
...
public class ChatEmotionFragment extends ChatBaseFragment {
    ...
    private void initEmotion() {
        // 获取屏幕宽度
        int screenWidth = BaseActivity.screenWidth;
        // item的间距
