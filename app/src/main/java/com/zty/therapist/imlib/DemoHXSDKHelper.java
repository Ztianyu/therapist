...
import com.zty.therapist.imlib.domain.User;
import com.zty.therapist.imlib.model.HXNotifier;
import com.zty.therapist.imlib.model.HXNotifier.HXNotificationInfoProvider;
import com.zty.therapist.imlib.model.HXSDKModel;
import com.zty.therapist.imlib.utils.CommonUtils;
        ...
        return new HXNotificationInfoProvider() {
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                if (message.getType() == Type.TXT) {
                    ticker = message.getBody().toString().replaceAll("txt:","");
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                if (chatType == ChatType.Chat) { // 单聊信息
                    /*intent.setClass(appContext, VipDoctorMainActivity.class);
                    VipDoctorModel vipDoctorModel = new VipDoctorModel();
                    vipDoctorModel.setUsername(message.getFrom());
                    intent.putExtra("model", vipDoctorModel);*/
//                    intent.putExtra("chatType", DoctorOnlineAnswerFragment.CHATTYPE_SINGLE);
                } else { // 群聊信息
                    // message.getTo()为群聊id
                    /*intent.setClass(appContext, HealthBBSMainActivity.class);
                    intent.putExtra("groupId", message.getTo());*/
//                    if(chatType == ChatType.GroupChat){
//                        intent.putExtra("chatType", CommunityCommFragment.CHATTYPE_GROUP);
//                    }else{
